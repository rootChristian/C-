namespace MVC_CSV_DB.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MVC_CSV_DB.DAL.AnagraficaIcpContext>
    {
        ...
        protected override void Seed(MVC_CSV_DB.DAL.AnagraficaIcpContext context)
        {
            try
            {
